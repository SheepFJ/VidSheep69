...
^https:\/\/api\.sheep\.com\/sheep\/videoPolymerization\/(userinfo\/username\/([^\/]+)|videoword\/([^\/]+)\/\?wd=([^\/]+)|videolist\/([^\/]+)) url script-response-body https://raw.githubusercontent.com/SheepFJ/VidSheep69/refs/heads/main/main/api.js
